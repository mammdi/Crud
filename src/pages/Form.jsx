...
const Form = () => {
  ...
  console.log(user, "userMammdi");
  return (
    <>
      <form className="max-w-md mx-auto m-10" onSubmit={handlerSubmit}>
        ...
        <div className="relative z-0 w-full mb-5 group">
          ...
          <label
            ...
            className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:star"
          >
            Password
          </label>
        </div>
